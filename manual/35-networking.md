...
The firewall is on by default and blocks all incoming traffic, with one exception: port 53317 from private networks (RFC1918, plus IPv6 link-local and ULA), so [LocalSend](22-guis.md) works on the LAN.
